...
const menu = {
  ...
  class AlaCarteItem {
    constructor(item, quantity) {
      ...
      this.price = item.isPremium ? menu.prices.entrees.premium : menu.prices.entrees.standard;
    }
  }
  ...
  class Drink {
    constructor(size) {
      this.type = "Drink";
      this.size = size;
      this.price = size === 'small' ? menu.prices.drinks.small : menu.prices.drinks.large;
    }
  }
